...
/**
 * This class represents a command executable that checks if two numbers are approximately equal.
 */
...
public class EqualCommand extends CommandExecutable {
  ...
  /**
   * Constructs a new {@code EqualCommand} with the specified parameter executables.
   *
   ...
   * @return 1 if the two numbers are approximately equal, and 0 otherwise
   */
  @Override
