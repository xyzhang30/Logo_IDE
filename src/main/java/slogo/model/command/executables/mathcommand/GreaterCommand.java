...
/**
 * This class represents a command executable that checks if one number is greater than another.
 */
...
public class GreaterCommand extends CommandExecutable {
  ...
  /**
   * Constructs a new {@code GreaterCommand} with the specified parameter executables.
   *
