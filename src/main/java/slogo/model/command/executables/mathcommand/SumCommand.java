...
/**
 * This class represents a command executable that calculates the sum of two numbers.
 */
...
public class SumCommand extends CommandExecutable {
  ...
  /**
   * Constructs a new {@code SumCommand} with the specified parameter executables.
   *
