...
/**
 * This class represents a command executable that returns the number of turtles currently active in
 * the environment.
 */
public class Turtles extends TurtleExecutable {
  ...
  /**
   * Executes the Turtles command, returning the total number of turtles currently active in the
   * environment.
   *
